...
export type TranslationKey =
  ...
  | 'listenPronunciation'
  | 'usefulPhrases'
  // Ajoute ici toutes les clés nécessaires...
...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  fr: {
    ...
    centralEuropeCountries:
      "Allemagne, Autriche, Slovénie, Croatie, Bosnie, Monténégro, Macédoine du Nord",
    balkans: "Balkans",
    ...
    centralAsiaCountries:
      "Kazakhstan, Ouzbékistan, Turkménistan, Tadjikistan, Kirghizistan",
    ...
    translationQuote:
      "La langue est la route de la culture, la clé de la compréhension.",
    writeIn: "Écrire en",
    translate: "Traduire",
  ...
  en: {
    ...
    centralEuropeCountries:
      "Germany, Austria, Slovenia, Croatia, Bosnia, Montenegro, North Macedonia",
    balkans: "Balkans",
    ...
    translationQuote:
      "Language is the road to culture, the key to understanding.",
    writeIn: "Write in",
    translate: "Translate",
  ...
  de: {
    ...
    centralEuropeCountries:
      "Deutschland, Österreich, Slowenien, Kroatien, Bosnien, Montenegro, Nordmazedonien",
    balkans: "Balkan",
    ...
    centralAsiaCountries:
      "Kasachstan, Usbekistan, Turkmenistan, Tadschikistan, Kirgisistan",
    farEast: "Fernost",
    ...
    translationQuote:
      "Sprache ist der Weg zur Kultur, der Schlüssel zum Verständnis.",
  ...
  ru: {
    ...
    centralEuropeCountries:
      "Германия, Австрия, Словения, Хорватия, Босния, Черногория, Северная Македония",
    balkans: "Балканы",
    ...
    centralAsiaCountries:
      "Казахстан, Узбекистан, Туркменистан, Таджикистан, Кыргызстан",
    ...
    translationQuote:
      "Язык — это дорога к культуре, ключ к пониманию.",
    writeIn: "Писать на",
    translate: "Перевести",
    translating: "Перевод...",
